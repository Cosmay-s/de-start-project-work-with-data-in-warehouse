...
-- Шаг 3. Скрипт для переноса данных из источника в хранилище.

-- 3.1 создание таблицы tmp_sources с данными из всех источников
...
-- 3.2 обновление существующих записей и добавление новых в dwh.d_craftsman
...
-- 3.3 обновление существующих записей и добавление новых в dwh.d_products
...
-- 3.4 обновление существующих записей и добавление новых в dwh.d_customer
...
-- 3.5 создание таблицы tmp_sources_fact
...
-- 3.6 обновление существующих записей и добавление новых в dwh.f_order
    ...
    SELECT  
      ...
      FROM (
            ...
            FROM (                        							
				 ...
				 INNER JOIN (
							  SELECT -- Самый популярный мастер определяется по количеству заказов от заказчика
